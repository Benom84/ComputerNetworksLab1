...
final class HttpRequest implements Runnable
{
	...
	private void processRequest() throws Exception
	{
		...
		if (!htmlRequest.isLegalRequest) {
			...
			responseToClient = resond501(htmlRequest);
		} else {
	...
	private HtmlResponse respond200(HtmlRequest htmlRequest) throws IOException {
		...
		String requestedFileFullPath = rootDirectory.getCanonicalPath() + htmlRequest.requestedFile;
		...
		response200.setEntityBody(bodySB.toString());
	...
	private String getContentTypeFromFile(String requestedFile) {
		...
		String[] splitFileRequest = requestedFile.split(".");
	...
	private HtmlResponse resond501(HtmlRequest htmlRequest) {
	...
	private HtmlResponse resond500(HtmlRequest htmlRequest) {
